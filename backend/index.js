...
/* ----------- REGISTER ----------- */
app.post(
  "https://ticketblaster-deploy.herokuapp.com/users/register",
...
/* ----------- LOGIN ----------- */
app.post(
  "https://ticketblaster-deploy.herokuapp.com/users/login",
  async (request, response) => {
    const email = request.body.email;
    const password = request.body.password;
...
/* Update Account by id
  Consumed at /admin                 */
app.post(
  "https://ticketblaster-deploy.herokuapp.com/users/admin/:id",
  async (request, response) => {
...
/*Update Account WITH PASSWORD by id
  Consumed at /account                 */
app.post(
  "https://ticketblaster-deploy.herokuapp.com/users/:id",
  async (request, response) => {
    const id = request.body.id;
    const email = request.body.email;
    const password = request.body.password;
...
app.get(
  "https://ticketblaster-deploy.herokuapp.com/users",
  async (req, res) => {
    try {
...
app.get(
  "https://ticketblaster-deploy.herokuapp.com/users/id/:id",
  async (req, res) => {
...
app.get(
  "https://ticketblaster-deploy.herokuapp.com/users/email/:email",
  async (req, res) => {
...
app.post(
  "https://ticketblaster-deploy.herokuapp.com/tickets/purchase",
  async (request, response) => {
    const id = request.body.id;
    const email = request.body.email;
...
/* get request to /users to get ALL users */
app.get(
  "https://ticketblaster-deploy.herokuapp.com/allTickets",
  async (req, res) => {
    try {
...
app.get("https://ticketblaster-deploy.herokuapp.com/", (req, res) => {
...
app.get("https://ticketblaster-deploy.herokuapp.com/api", (req, res) => {
  const options = {
    method: "GET",
